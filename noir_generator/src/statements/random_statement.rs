...
pub fn generate_random_statement(bloc_variables: &mut BlocVariables, list_functions: &ListFunctions, list_structs: &ListStructs) -> String {
    let mut instruction: String = String::new();

    match random::gen_range(0, 3) {
        0 => instruction = format!("{}{}", instruction, variable_declaration_statement::generate_variable_declaration(bloc_variables, list_functions, list_structs)),
