...
pub fn only_acir<P: AsRef<Path>>(program_artifact: &ProgramArtifact, circuit_dir: P) -> PathBuf {
...
pub fn save_debug_artifact_to_file<P: AsRef<Path>>(
...
pub fn read_debug_artifact_from_file<P: AsRef<Path>>(
