...
pub fn generate_variable_declaration(bloc_variables: &mut BlocVariables, list_functions: &ListFunctions, list_structs: &ListStructs) -> String {

    let chosen_type = var_type::random_type(list_structs);
